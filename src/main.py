...
async def get_merchant(mid: int):
    ...
    try:
        ...
        response_msg["message"] = "Merchant ID retrieved successfully!"
...
async def update_fee(mid: int, fee: int):
    ...
    try:
        ...
        response_msg["message"] = "Merchant fee updated succesfully!"
        logger.info(response_msg)
...
async def repay(name: str, amount: int):
    ...
    try:
        ...
        response_msg["message"] = "Repayment successfully"
        logger.info(response_msg)
    except Exception as ex:
        response_msg["status"] = "failed"
        response_msg["message"] = str(ex)
...
async def get_users_at_limit():
    ...
    try:
        ...
        response_msg["status"] = "failed"
        response_msg["message"] = str(ex)
        logger.erroe(response_msg["message"])
    finally:
        cursor.close()
        conn.close()
    return {"users": users}
...
async def get_total_dues():
    ...
    try:
        ...
        response_msg["message"] = "total dues retrieved succesfully!"
        logger.info(response_msg)
    except Exception as ex:
        response_msg["status"] = "failed"
        response_msg["message"] = str(ex)
